...
public class EnvUtil {
    ...
    public static void environmentInit(String enableProxy, String proxy, String port, String googleTranslateText, String googleTranslateAudio,String googleTranslateDetect,String locale)
	{
